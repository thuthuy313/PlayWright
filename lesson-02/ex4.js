...
console.log(`Cân nặng lý tưởng của bạn là: ${(chieucao) * 9 / 10} kg `);
console.log(`Mức cân tối đa của bạn là: ${chieucao} kg` );
console.log(`Mức cân tối thiểu của bạn là: ${(chieucao * 8 ) / 10} kg`);
